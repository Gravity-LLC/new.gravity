    ...
    return <Detiled 
        ...
        content={()=>(
            <>
                ...
                <div className="container pt-5">
                    <div className="mb-5" style={{overflow: 'hidden'}}>
                        <h6 className="animate__animated animate__fadeInDown" >{langeText.tasksHeading}</h6>
                        {
                            langeText.tasks.map((el, idx) => <p className="col-md-7 px-0 animate__animated animate__fadeInDown wow " data-wow-duration="1.2s" key={idx}>{el}</p>)
                        }
                    </div>
                </div>
                ...
                <div className="imageWrapper animate__animated animate__slideInUp wow mb-5" data-wow-offset="50" data-wow-duration="1.5s">
